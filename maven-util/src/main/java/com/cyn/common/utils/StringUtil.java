...
public class StringUtil {
	...
	public static String randomChineseName() {
		String[] lastname = { "赵", "钱", "孙", "李", "周", "吴", "郑", "王", "冯", "陈", "褚", "卫", "蒋", "沈", "韩", "杨", "朱", "秦",
		...
		// 随机获取姓氏
		String name1=lastname[RandomUtil.randomNum(lastname.length-1,0)];
		String name2 = randomChinese(RandomUtil.randomNum(2, 1));
		return name1+name2;
	}
	//验证
	public static void main(String[] args) {
		...
		/*System.out.println(randomChinese(5));*/
